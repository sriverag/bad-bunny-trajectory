...
export async function main() {
  ...
  const oasis = await prisma.album.create({
    data: {
      ...
      tracks: {
        create: [
          { title: "MOJAITA", trackNumber: 1, durationMs: 187000, danceability: 0.78, energy: 0.72, valence: 0.60, tempo: 96.0, acousticness: 0.08 },
          { title: "YO LE LLEGO", trackNumber: 2, durationMs: 250000, danceability: 0.80, energy: 0.75, valence: 0.65, tempo: 92.0, acousticness: 0.06 },
          { title: "CUIDAO POR AHÍ", trackNumber: 3, durationMs: 198000, danceability: 0.76, energy: 0.70, valence: 0.55, tempo: 100.0, acousticness: 0.10 },
          { title: "QUÉ PRETENDES", trackNumber: 4, durationMs: 222000, danceability: 0.82, energy: 0.68, valence: 0.70, tempo: 94.0, acousticness: 0.12 },
          { title: "LA CANCIÓN", trackNumber: 5, durationMs: 243000, danceability: 0.72, energy: 0.58, valence: 0.45, tempo: 88.0, acousticness: 0.25 },
          { title: "UN PESO", trackNumber: 6, durationMs: 277000, featuring: "Marciano Cantero", danceability: 0.74, energy: 0.65, valence: 0.50, tempo: 98.0, acousticness: 0.15 },
          { title: "ODIO", trackNumber: 7, durationMs: 270000, danceability: 0.70, energy: 0.62, valence: 0.40, tempo: 86.0, acousticness: 0.20 },
          { title: "COMO UN BEBÉ", trackNumber: 8, durationMs: 219000, featuring: "Mr Eazi", danceability: 0.76, energy: 0.72, valence: 0.58, tempo: 102.0, acousticness: 0.08 },
        ],
      },
    },
  });
  ...
  const collaborations = await prisma.album.create({
    data: {
      ...
      tracks: {
        create: [
          { title: "I Like It", trackNumber: 1, durationMs: 253000, featuring: "Cardi B, J Balvin", spotifyId: "58q2HKrzhC3ozto2nDdN4z" },
          { title: "La Jumpa", trackNumber: 2, durationMs: 255000, featuring: "Arcángel", spotifyId: "5MxFWjuqQIsbNWbMdMdbli" },
          { title: "Un x100to", trackNumber: 3, durationMs: 214000, featuring: "Grupo Frontera", spotifyId: "6pD0ufEQq0xdHSsRbg9LBK" },
          { title: "Coco Chanel", trackNumber: 4, durationMs: 222000, featuring: "Eladio Carrión", spotifyId: "0PB0O24JqAuNdOAFVJljMS" },
          { title: "Te Boté (Remix)", trackNumber: 5, durationMs: 359000, featuring: "Nio García, Casper Mágico, Darell, Nicky Jam, Ozuna", spotifyId: "3V8UKqhEK5zBkBb6d6ub8i" },
          { title: "Un Día (One Day)", trackNumber: 6, durationMs: 228000, featuring: "J Balvin, Dua Lipa, Tainy", spotifyId: "0EhpEsp4L0oRGM0vmeaN5e" },
          { title: "Kemba Walker", trackNumber: 7, durationMs: 159000, featuring: "Eladio Carrión", spotifyId: "38kLHBjtWJaPXcyFhwRVtI" },
          { title: "Lo Siento BB:/", trackNumber: 8, durationMs: 218000, featuring: "Tainy, Julieta Venegas", spotifyId: "4gzsuuZypVbxs0Af1LSZyB" },
          { title: "Mojabi Ghost", trackNumber: 9, durationMs: 211000, featuring: "Tainy", spotifyId: "46YjJXVXWHlQ21odKktg5e" },
          { title: "Ella Baila Sola", trackNumber: 10, durationMs: 243000, featuring: "Eslabon Armado" },
          { title: "Diles", trackNumber: 11, durationMs: 240000, featuring: "Ozuna, Farruko, Arcángel, Ñengo Flow", spotifyId: "6C1RD7YQVvt3YQj0CmuTeu" },
          { title: "Con Altura", trackNumber: 12, durationMs: 161000, featuring: "Rosalía, El Guincho", spotifyId: "2qG5sZ7Si6sdK74qLxedYM" },
          { title: "Satisfacción", trackNumber: 13, durationMs: 224000, featuring: "Nicky Jam", spotifyId: "21WvAGxPUNJARcZoSqswd7" },
          { title: "KPOP", trackNumber: 14, durationMs: 171000, featuring: "Travis Scott", spotifyId: "5L3ecxQnQ9qTBmnLQiwf0C" },
        ],
      },
    },
  });
  ...
  const singles = await prisma.album.create({
    data: {
      ...
      tracks: {
        create: [
          { title: "Soy Peor", trackNumber: 1, durationMs: 247000, spotifyId: "1JxhrUWZjuI8AOjDJ1JpMN" },
          { title: "Chambea", trackNumber: 2, durationMs: 210000, spotifyId: "1Bqg4yFeVDJxchh6MjkGKy" },
          { title: "Tu No Metes Cabra", trackNumber: 3, durationMs: 198000, spotifyId: "43SMQMC2X2fAOuTPRnSGrG" },
          { title: "Amorfoda", trackNumber: 4, durationMs: 245000, spotifyId: "68QcquxCS39cQGTsRrJWIR" },
          { title: "Yonaguni", trackNumber: 5, durationMs: 206000, spotifyId: "2JPLbjOn0wPCngEot2STUS" },
          { title: "Alambre Púa", trackNumber: 6, durationMs: 199000, spotifyId: "0WDvsKwqhn9alx29Z80DmG" },
        ],
      },
    },
  });
